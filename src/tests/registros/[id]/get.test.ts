...
describe("GET to /v1/registros/[id]", async () => {
  test("Deve retornar um registro válido", async () => {
    ...
    expect(response.body.nome).toEqual("TESTADOR");
    expect(response.body.criado_em).toEqual(expect.any(String));
